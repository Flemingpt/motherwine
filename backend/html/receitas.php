            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestão de Receitas</h4>
                    </div>
                    ...
                    <div class="white-box">
                        <form class="form-horizontal form-material">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Nome da receita" id="nome"
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success" id="uploadimg" onclick='uploadImg(document.getElementById("upload").files)'>Registar Receita</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <div class="table-responsive">
                                <table id="recipes" class="display" style="width:100%">
                                        <thead>
                                            <tr><th class="recipeid">ID</th>
                ...
                <div class="modal-dialog modal-confirm">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Receita eliminada com sucesso!</h4>	
                        </div>
