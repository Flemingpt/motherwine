                            ...
                            <div class="main-menu d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="active" href="wines.php">Vinhos</a></li>
                            ...
                            <div class="row mt-2">
                                <div class="col-10 col-md-8 col-lg-12" style="left:-0.65%;">
                                        <div class="bg-light rounded rounded-pill shadow-sm mb-2 mt-3">
                                            <select name="search_wine" id="search_wine" class="js-example-placeholder-single5" style="width:100%;">
                                                <option></option>     
